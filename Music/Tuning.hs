...
-- represent tuning as a list of freqs mapping [0..127] to H
type Tuning = [Freq]
...
allTuningPackage = justTuningPackage ++ equalTuningPackage ++ pythagoreanTuningPackage ++ meantoneTuningPackage ++ miscTuningPackage
